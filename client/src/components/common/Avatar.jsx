    ...
    <>
      <div className="flex items-center justify-center">
        ...
        {type === "xl" && (
          ...
          >
            <div
              className={`absolute bg-photopicker-overlay-background h-60 w-60 top-0 left-0 flex items-center rounded-full justify-center flex-col text-center gap-2 z-10 ${
